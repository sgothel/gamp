 ...
 */
#ifndef JAU_GAMP_GRAPH_TESS_CDTesselator2D_HPP_
#define JAU_GAMP_GRAPH_TESS_CDTesselator2D_HPP_
...
namespace gamp::graph::tess {
    ...
    class CDTriangulator2D { // : public Triangulator {
      ...
      private:
        ...
        impl::LoopRef getContainerLoop(const Outline& polyline) noexcept {
...
#endif /*  JAU_GAMP_GRAPH_TESS_CDTesselator2D_HPP_ */
