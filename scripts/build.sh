...
buildit() {
    ...
    cmake $CLANG_ARGS $CXX_ARGS -DCMAKE_INSTALL_PREFIX=$rootdir/$dist_dir -DBUILD_TESTING=ON -DUSE_LIBUNWIND=ON ..
    # cmake $CLANG_ARGS $CXX_ARGS -DCMAKE_INSTALL_PREFIX=$rootdir/$dist_dir -DBUILD_TESTING=ON -DUSE_LIBUNWIND=ON -DDEBUG=ON ..
