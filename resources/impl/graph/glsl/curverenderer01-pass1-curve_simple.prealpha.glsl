    ...
    if( gcv_CurveParam.x == 0.0 && gcv_CurveParam.y == 0.0 ) {
        ...
        vec4 t = gcuTexture2D(gcu_ColorTexUnit, gcv_ColorTexCoord.st) * gcu_ColorStatic;
        mgl_FragColor = vec4(vec3(t.rgb * gcu_ColorStatic.rgb) * t.a * gcu_ColorStatic.a, t.a * gcu_ColorStatic.a);
#elif defined(USE_COLOR_CHANNEL)
        // mgl_FragColor = gcv_Color * gcu_ColorStatic;
        mgl_FragColor = vec4(vec3(gcv_Color.rgb * gcu_ColorStatic.rgb) * gcv_Color.a * gcu_ColorStatic.a, gcv_Color.a * gcu_ColorStatic.a);
#else
        // mgl_FragColor = gcu_ColorStatic;
        mgl_FragColor = vec4(gcu_ColorStatic.rgb * gcu_ColorStatic.a, gcu_ColorStatic.a);
#endif
    } else {
        // pass-1: curves
        ...
        mgl_FragColor = vec4(t.rgb * gcv_Color.rgb * gcu_ColorStatic.rgb, gcu_ColorStatic.a * a);
#elif defined(USE_COLOR_TEXTURE)
        vec4 t = gcuTexture2D(gcu_ColorTexUnit, gcv_ColorTexCoord.st);
        // mgl_FragColor = vec4(t.rgb * gcu_ColorStatic.rgb, t.a * gcu_ColorStatic.a * a);
        mgl_FragColor = vec4(vec3(t.rgb * gcu_ColorStatic.rgb) * t.a * gcu_ColorStatic.a * a, t.a * gcu_ColorStatic.a * a);
#elif defined(USE_COLOR_CHANNEL)
        // mgl_FragColor = vec4(gcv_Color.rgb * gcu_ColorStatic.rgb, gcv_Color.a * gcu_ColorStatic.a * a);
        mgl_FragColor = vec4(vec3(gcv_Color.rgb * gcu_ColorStatic.rgb) * gcv_Color.a * gcu_ColorStatic.a * a, gcv_Color.a * gcu_ColorStatic.a * a);
#else
        // mgl_FragColor = vec4(gcu_ColorStatic.rgb, gcu_ColorStatic.a * a);
        mgl_FragColor = vec4(gcu_ColorStatic.rgb * gcu_ColorStatic.a * a, gcu_ColorStatic.a * a);
#endif
    }
