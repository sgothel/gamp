...
class Glyph05FreeSerifBoldItalic_ae {
    public:
      static void addShapeToRegion(gamp::graph::OutlineShape& shape) {
        ...
        shape.addVertex(pos0, 0.450000f, -0.013000f, 0, true);
        jau::PLAIN_PRINT(true, "Glyph05FreeSerifBoldItalic_ae.shape01a.winding_area: %s", jau::math::geom::to_string(shape.windingOfLastOutline()).c_str());
        shape.closeLastOutline(false);
        ...
        shape.addVertex(pos0, 0.194000f, 0.058000f, 0, true);
        jau::PLAIN_PRINT(true, "Glyph05FreeSerifBoldItalic_ae.shape02a.winding_area: %s", jau::math::geom::to_string(shape.windingOfLastOutline()).c_str());
        shape.closeLastOutline(false);
        ...
        if( true ) {
            ...
            // Shape.LineTo:
            shape.addVertex(pos0, 0.438000f, 0.214000f, 0, true);
            jau::PLAIN_PRINT(true, "Glyph05FreeSerifBoldItalic_ae.shape03a.winding_area: %s", jau::math::geom::to_string(shape.windingOfLastOutline()).c_str());
            shape.closeLastOutline(false);
        }
